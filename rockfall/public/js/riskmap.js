...
function renderUserAndStatus() {
  // Make sure window.currentUser is set in riskmap.ejs
  if (window.currentUser) {
    userNameEl.textContent = window.currentUser.username;
    userRoleEl.textContent = window.currentUser.role;
    userNameHeader.textContent = window.currentUser.username;
    userRoleHeader.textContent = window.currentUser.role;
  }
